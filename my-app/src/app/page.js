...
export const metadata = {
  title: "Other code | Главная",
  description: "Уникальные цифровые продукты для бизнеса и государства. Помогаем создавать эффективные digital-продукты, основанные на глубокой аналитике и здравом смысле.",
  openGraph: {
    title: "Other code | Главная",
    description: "Уникальные цифровые продукты для бизнеса и государства.",
    url: "https://othercode.ru/",
    type: "website",
  },
  twitter: {
...
export default function Home() {
  return (
    <main className="flex flex-col gap-20 sm:gap-[6.25rem] md:gap-[9.375rem] mb-to-footer">
      <section className="relative h-screen overflow-hidden" aria-label="Вступительный видеоблок">
        <div className="absolute inset-0 w-full h-full -z-10">
          <video
            ...
            aria-label="Видеофон: цифровые продукты для бизнеса и государства"
          />
        </div>
        <div className="flex flex-col sm:flex text-white justify-end sm:justify-center h-full w-full">
          <div className="flex px-main w-full pb-20 sm:pb-0">
            ...
            w-full lg:w-2/3 2xl:w-[70%] 3xl:w-[65%] 3-5xl:w-[60%] 4xl:w-[50%]"> 
              <h1 className="text-[36px] md:text-[80px]">Уникальные цифровые продукты для бизнеса и государства</h1>
              <p>
