...
export default function SendForm({ closeModal }) {
  ...
  return (
    <div>
      ...
      <form onSubmit={sendToTelegram} encType="multipart/form-data" className="pt-[29px] sm:pt-10">
        <div className='sm:grid sm:grid-cols-2 sm:grid-rows-5 sm:gap-4 gap-6 flex flex-col'>
          ...
          <div>
            ...
            />
            {formErrors.name && <p className="text-red text-sm mt-1">{formErrors.name}</p>}
          </div>
          ...
          <div>
            ...
            />
            {formErrors.phone && <p className="text-red text-sm mt-1">{formErrors.phone}</p>}
          </div>
          ...
          <div className="col-span-2">
            ...
            />
            {formErrors.mail && <p className="text-red text-sm mt-1">{formErrors.mail}</p>}
          </div>
          ...
          <div className="col-span-2 row-span-3">
            ...
            />
            {formErrors.message && <p className="text-red text-sm mt-1">{formErrors.message}</p>}
          </div>
        </div>
        ...
        <ul className="mt-2 text-sm text-dark-grey list-disc pl-5">
