...
export const metadata = {
  ...
  description: "О компании Other code: уникальный подход к разработке цифровых решений для любых задач. Создаём IT-продукты без шаблонов, оцениваем каждый проект индивидуально.",
  openGraph: {
    title: "Other code | О нас",
    description: "О компании Other code: уникальный подход к разработке цифровых решений для любых задач.",
    url: "https://othercode.ru/about_us",
    type: "website",
  },
  twitter: {
...
export default function AboutUsPage() {
  return(
    ...
    className="flex flex-col gap-20 sm:gap-[6.25rem] md:gap-[9.375rem] mb-to-footer">
      <section className="relative h-screen overflow-hidden" aria-label="Видеоблок о компании">
        <div className="absolute inset-0 w-full h-full -z-10">
          <video
            ...
            aria-label="Видеофон: команда Other code и цифровые решения"
          />
        </div>
        <div className="flex flex-col sm:flex text-white justify-end sm:justify-center h-full w-full sm:pb-0 pb-10">
          <div className="flex flex-col px-main w-full">
            ...
            w-full lg:w-2/3 2xl:w-[70%] 3xl:w-[65%] 3-5xl:w-[60%] 4xl:w-[50%]">
              <h1>Кто мы и почему мы другие?</h1>
              <p>
